        ...
        <div class="col s4 offset-s1">
            ...
            <form action="" method="post">
                <div class="input-field inline">
                    <ul>
                        <li>
                            <label for="namaTokoBanten">Nama Toko Banten</label>
                            <input type="text" size=50 id="namaTokoBanten" name="namaTokoBanten" placeholder="Nama Toko Banten">
                        </li>
                        <li>
...
function registrasi($agen){
    ...
    // ambil data agen
    $namaTokoBanten = htmlspecialchars($agen["namaTokoBanten"]);
...
if (isset($_POST["daftar"])) {
    ...
    if  ( registrasi($_POST) > 0) {
        ...
        echo "
            <script>
                Swal.fire('Pendaftaran Agen Berhasil','Silahkan Mengisi Data Harga Banten','success').then(function(){
