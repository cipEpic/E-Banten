...
<?php include 'header.php'; ?>
    <div class="row">
        <h3 class="header col s12 light center">Riwayat Transaksi Banten</h3>
        <br>
                    ...
                    <td>
                        <?php if ( $transaksi["komentar"] == "" ) : ?>
                            <form action="" method="post">
                                ...
                                <div class="center"><button class="btn green darken-2" type="submit" name="kirimKomentar"><i class="material-icons">send</i></button></div>
                            </form>
                        <?php else : ?>
                        <?= $transaksi["komentar"] ?>
                        <?php endif; ?>
