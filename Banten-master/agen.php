                ...
                <div class="input-field">
                    <ul>
                        <li>
                            ...
                            <input type="text" id="namaTokoBanten" name="namaTokoBanten" value="<?= $agen['nama_tokobanten']?>">
                        </li>
                        <li>
                        ...
                        <li>
                            <div class="center">
                                <button class="btn-large green darken-2" type="submit" name="simpan">Simpan Data</button>
                            </div>
                        </li>
...
if ( isset($_POST["simpan"]) ){
    ...
    //ambil data
    $namaTokoBanten = htmlspecialchars($_POST["namaTokoBanten"]);
    ...
    $query = "UPDATE agen SET
        nama_tokobanten = '$namaTokoBanten',
